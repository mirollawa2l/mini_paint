 ...
 * @author mirol
 */
public class RectangleWindow1 extends javax.swing.JDialog {
    ...
    /**
     * Creates new form RectangleWindow1
     */
    public RectangleWindow1(java.awt.Frame parent, boolean modal) {
         super(parent, modal);
        initComponents();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(40, 40, 40)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(inputWidth, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(inputLength, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Draw))))
    ...
    private void DrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DrawActionPerformed
        ...
        String inw = inputWidth.getText();

        String inl = inputLength.getText();

        if (inx.isEmpty() || iny.isEmpty() || inw.isEmpty() || inl.isEmpty())
        JOptionPane.showMessageDialog(this, "Some fields are Empty");
        else {
            x = Integer.parseInt(inx);
            y = Integer.parseInt(iny);
            width = Double.parseDouble(inw);
            length = Double.parseDouble(inl);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RectangleWindow1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RectangleWindow1 dialog = new RectangleWindow1(new javax.swing.JFrame(), true);
